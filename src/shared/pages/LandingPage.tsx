...
function LandingPage() {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
        ...
        <div className="max-w-[1200px] mx-auto px-8">
          ...
          >
            ...
            >
              ...
              <p className="text-[#666] leading-relaxed">
                Your notes are encrypted and private. Only you can access your
                thoughts.
              </p>
            </div>
      ...
      {/* <footer className="mt-16 border-t border-[#e5e5e5] py-12 text-center"> */}
      ...
      <div className="py-16 text-center text-[#888] text-[1.1rem]">
        <div className="max-w-7xl mx-auto px-8">
          Free, open, and built for people who just want to take notes.
        </div>
      </div>
    </div>
  );
