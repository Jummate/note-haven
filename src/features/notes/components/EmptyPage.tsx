  ...
  return (
    <>
      <div className="hidden lg:grid grid-cols-[1fr_2fr] flex-1">
        <div className="p-10 px-7 border border-r-1 border-y-0 border-l-0 border-secondary-dark">
          <div className="mb-12">
            <CreateNoteButton />
          </div>
      ...
      <div className="flex flex-col flex-1 lg:hidden bg-secondary-100">
        ...
        <div className="flex flex-1 justify-center">
          <div className="p-8 text-default font-inter w-full bg-inverted relative">
