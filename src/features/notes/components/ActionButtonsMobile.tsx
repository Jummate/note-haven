    ...
    <div className={clsx("flex gap-3", styles)}>
      <div className="flex flex-1 justify-between">
        <button className="flex gap-2 items-center text-2xl cursor-pointer hover:text-primary-500/80">
          <ChevronLeftIcon aria-hidden="true" className="text-secondary-500 text-4xl" />
          Go Back
        </button>
        {showActionButtons && (
          <div className="flex gap-5 items-center text-2xl">
            {type && (
              <button aria-label="Delete Note" className="hover:text-primary-500/80">
                <DeleteIcon
            ...
            {type === "active" && (
              <button aria-label="Archive Note" className="hover:text-primary-500/80">
                <ArchivedIcon
                  className="cursor-pointer"
                  aria-hidden="true"
                />
